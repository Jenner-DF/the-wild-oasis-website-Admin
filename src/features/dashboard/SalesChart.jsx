...
function SalesChart({ bookings, numDays }) {
  //get all dates based on the filter last 7,30,90 days
  ...
  //     return { ...booking, created_at: format(booking.created_at, "MM dd") };
  //   })
  // );
  const data = allDates.map((date) => {
    return {
      ...
      totalSales: bookings
        .filter((booking) => isSameDay(booking.created_at, new Date(date)))
